...
### How do I remove React Router?
 ...
 3. Remove `import { Link, IndexLink } from 'react-router';` from top of `src/components/App.js`, add a reference to `src/components/MaterialUIForm.js`, and replace body of (implicit) render with this: `<MaterialUIPage />`.
